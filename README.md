...
<div style='font-size:13px;opacity:0.92;'>Lineage heat: 2 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: todo · PII: none · Changelog: fresh (2 d)</div>
</div>
...
- Pkg folder: [packages\book-categories](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\book-categories)
...
graph LR
  ...
  book_categories["book_categories"]:::center
  book_categories -->|FK| books["books"]:::link
  book_categories -->|FK| categories["categories"]:::accent
...
- Outbound (depends on): "books", "categories"
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package book-categories -Apply
