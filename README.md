...
> Lineage: 2 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: todo · PII flags: 0 · Changelog: fresh (2 d)
...
| Pkg folder | [packages\book-categories](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\book-categories) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package book-categories -Apply
