...
final class BookCategoryRepository implements RepoContract {
    ...
    public function insert(array $row): void {
        ...
        $tblEsc  = $isMysql ? '`book_categories`' : '"book_categories"';
     ...
     * [ 'book_id', 'category_id' ] = unikátní klíče (sloupce) pro konflikty,
