...
namespace BlackCat\Database\Packages\BookCategories\Mapper;

use BlackCat\Database\Packages\BookCategories\Dto\BookCategoryDto;
use BlackCat\Database\Packages\BookCategories\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO BookCategoryDto:
 ...
 */
final class BookCategoryDtoMapper
{
    /** @var array<string,string> Column -> DTO property */
    private const COL_TO_PROP = [ 'tenant_id' => 'tenantId', 'book_id' => 'bookId', 'category_id' => 'categoryId', 'created_at' => 'createdAt', 'updated_at' => 'updatedAt' ];

    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'tenant_id', 'book_id', 'category_id' ];
    /** @var string[] */
     ...
     */
    public static function fromRow(array $row): BookCategoryDto
    {
        /** @var BookCategoryDto */
        return DtoHydrator::fromRow(
            BookCategoryDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?BookCategoryDto
    {
     ...
     *
     * @param BookCategoryDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(BookCategoryDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(BookCategoryDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(BookCategoryDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,BookCategoryDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,BookCategoryDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(BookCategoryDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,BookCategoryDto>
     */
