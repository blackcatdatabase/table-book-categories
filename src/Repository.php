...
use BlackCat\Database\Packages\BookCategories\Repository\BookCategoryRepository as GeneratedRepository;
...
{
  private BookCategoryRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof BookCategoryRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected BookCategoryRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\BookCategories\Dto\BookCategoryDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\BookCategories\Dto\BookCategoryDto|null { return $this->repo->getById($id, $asDto); }
