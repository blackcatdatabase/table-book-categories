...
use BlackCat\Database\Packages\BookCategories\Repository\BookCategoryRepository;
...
final class Repository
{
    ...
    {
        $this->repo = new BookCategoryRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\BookCategories\Dto\BookCategoryDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\BookCategories\Dto\BookCategoryDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\BookCategories\Dto\BookCategoryDto|null
    {
