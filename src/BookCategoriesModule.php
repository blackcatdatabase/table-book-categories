...
final class BookCategoriesModule implements ModuleInterface {
    ...
    public function name(): string { return 'table-book_categories'; }
    public function table(): string { return 'book_categories'; }
    public function version(): string { return '1.0.0'; }
    /** @return string[] */
    public function dialects(): array { return [ 'mysql', 'postgres' ]; }
    /** @return string[] */
    public function dependencies(): array { return [ 'table-books', 'table-categories' ]; }
    ...
    public function status(Database $db, SqlDialect $d): array {
        ...
        $indexes = [ 'idx_book_categories_category' ];
        $fks     = [ 'fk_book_categories_book', 'fk_book_categories_category' ];
        $missingIdx = [];
        $missingFk  = [];
