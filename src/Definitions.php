...
final class Definitions {
     ...
     * book_id category_id může být "id" nebo "col1, col2".
     * @return string[]
     */
    public static function pkColumns(): array {
        $raw = 'book_id category_id';
    ...
    public static function defaultOrder(): ?string {
        $c = 'book_id category_id DESC'; return $c !== '' ? $c : null;
    }

    /** @return array<int,array<int,string>> seznam unikátních klíčů */
    public static function uniqueKeys(): array { return [ [ 'book_id', 'category_id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'book_id', 'category_id' ]; }
