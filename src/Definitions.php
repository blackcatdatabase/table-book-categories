...
final class Definitions {
    ...
    /** @return string[] */
    public static function columns(): array { return [ 'tenant_id', 'book_id', 'category_id', 'created_at', 'updated_at' ]; }
     ...
     * tenant_id book_id category_id may be "id" or "col1, col2".
     * @return string[]
     */
    public static function pkColumns(): array {
        $raw = trim('tenant_id book_id category_id');
        if ($raw === '') {
            throw new \InvalidArgumentException('Definitions::pkColumns(): token tenant_id book_id category_id must not be empty.');
        }
    ...
    public static function defaultOrder(): ?string {
        $c = trim('created_at DESC, tenant_id book_id category_id DESC'); return $c !== '' ? $c : null;
    }

    /** @return array<int,array<int,string>> list of unique keys */
    public static function uniqueKeys(): array { return [ [ 'tenant_id', 'book_id', 'category_id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'tenant_id', 'book_id', 'category_id' ]; }
